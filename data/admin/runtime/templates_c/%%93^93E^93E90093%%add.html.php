<?php /* Smarty version 2.6.26, created on 2016-11-14 14:03:30
         compiled from default/Fcontent/add.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'U', 'default/Fcontent/add.html', 2, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "default/Public/header.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<form method="post" action="<?php echo $this->_plugins['function']['U'][0][0]->_U(array('url' => 'fcontent/add?dosubmit=1'), $this);?>
" class="validate">
<div id="pageTop">
<div class="tabs">
<ul>
	<li><a href='#' class="selected" rel="tabsContent1"><span>基本信息</span></a></li>
	<li><a href='#' rel="tabsContent2"><span>高级选项</span></a></li>
</ul>
</div>
</div>
<div id="pageCo">
...
"><?php echo $this->_tpl_vars['ss']['zs_name']; ?>
</option>
...
"><?php echo $this->_tpl_vars['fl']['nickname']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
			</select>
		</td>
